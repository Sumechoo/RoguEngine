...
import { GizmosEditor, Sandbox, Editor, Columns, Demo, Demo2, Dungeon, GameStateEditor } from "../../../../components/levels";
import { API } from "../../../../components/singletons/API";

function getLevelsMenu() : MenuItem[] {
    const levelsList: Array<typeof Level> = [GizmosEditor, Sandbox, Editor, Columns, Demo, Demo2, Dungeon, GameStateEditor];
